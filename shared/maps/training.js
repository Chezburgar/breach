...
function shootHouse(b) {
  ...
  // underside blocked the top third of the flight. The cut ends exactly at
  // the top tread: a metre longer, as it was, and you step off the stairs
  // into a five metre drop.
  b.slabHole(X0 - 2.4, Z0, X0, Z1 + 2.4, 5.6, 0.28, 'metal',
    [X0 - 2.4, Z1 + 2.0 - 24 * 0.30, X0, Z1 + 2.4]);
