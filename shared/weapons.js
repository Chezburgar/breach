...
const DEFS = [
  // ---------------- Assault rifles ----------------
  {
    ...
    spread: { hip: 5, hipMove: 2.2, ads: 0.16, adsMove: 0.9, growth: 0.36, decay: 5.2, max: 6.5 },
  ...
  },
  {
    ...
    spread: { hip: 5.6, hipMove: 2.4, ads: 0.17, adsMove: 1.0, growth: 0.40, decay: 5.0, max: 7.0 },
  ...
  },
  {
    ...
    spread: { hip: 4.7, hipMove: 2.0, ads: 0.14, adsMove: 0.85, growth: 0.31, decay: 5.6, max: 6.0 },
  ...
  },
  {
    ...
    spread: { hip: 5.2, hipMove: 2.1, ads: 0.13, adsMove: 0.80, growth: 0.28, decay: 5.8, max: 6.0 },
  ...
  },
  {
    ...
    spread: { hip: 5.4, hipMove: 2.3, ads: 0.18, adsMove: 0.95, growth: 0.34, decay: 6.0, max: 6.8 },
  ...
  },
  {
    ...
    spread: { hip: 5, hipMove: 2.0, ads: 0.14, adsMove: 0.82, growth: 0.30, decay: 5.7, max: 6.2 },
  ...
  // ---------------- SMGs ----------------
  {
    ...
    spread: { hip: 4, hipMove: 1.7, ads: 0.13, adsMove: 0.72, growth: 0.24, decay: 6.6, max: 5.2 },
  ...
  },
  {
    ...
    spread: { hip: 3.7, hipMove: 1.6, ads: 0.15, adsMove: 0.70, growth: 0.20, decay: 7.2, max: 4.8 },
  ...
  },
  {
    ...
    spread: { hip: 3.9, hipMove: 1.6, ads: 0.14, adsMove: 0.68, growth: 0.19, decay: 7.4, max: 4.6 },
  ...
  },
  {
    ...
    spread: { hip: 3.9, hipMove: 1.7, ads: 0.14, adsMove: 0.72, growth: 0.23, decay: 6.9, max: 5.0 },
    scopes: ['reddot', 'holo', 'reflex', 'x15'], defaultScope: 'reflex',
  ...
  // ---------------- Shotgun ----------------
  {
    ...
    spread: { hip: 6.4, hipMove: 2.0, ads: 3.1, adsMove: 1.0, growth: 0.0, decay: 5.0, max: 8.0, pelletCone: 3.4 },
    scopes: ['iron', 'reddot', 'holo', 'reflex'], defaultScope: 'reddot',
  ...
  // ---------------- Marksman ----------------
  {
    ...
    damage: 61, rpm: 450, mag: 1, reserve: 24, fireModes: ['semi'],
    reload: 1.55, reloadEmpty: 1.55, adsTime: 0.34, mobility: 0.80,
    ...
    spread: { hip: 7.2, hipMove: 2.8, ads: 0.04, adsMove: 1.4, growth: 0.55, decay: 4.4, max: 7.5 },
  ...
  },
  {
    ...
    damage: 65, rpm: 450, mag: 1, reserve: 24, fireModes: ['semi'],
    reload: 1.62, reloadEmpty: 1.62, adsTime: 0.35, mobility: 0.79,
    ...
    spread: { hip: 7.6, hipMove: 2.9, ads: 0.04, adsMove: 1.5, growth: 0.58, decay: 4.2, max: 7.8 },
  ...
  // ---------------- LMG ----------------
  {
    ...
    spread: { hip: 6.8, hipMove: 3.2, ads: 0.22, adsMove: 1.6, growth: 0.30, decay: 4.6, max: 8.0 },
  ...
  // ---------------- Sidearms ----------------
  {
    ...
    spread: { hip: 4.2, hipMove: 2.0, ads: 0.18, adsMove: 1.0, growth: 0.42, decay: 6.0, max: 6.0 },
  ...
  },
  {
    ...
    spread: { hip: 5, hipMove: 2.4, ads: 0.14, adsMove: 1.3, growth: 0.70, decay: 5.0, max: 7.0 },
    scopes: ['iron', 'reddot'], defaultScope: 'iron',
  ...
  },
  {
    ...
    spread: { hip: 3.8, hipMove: 1.8, ads: 0.16, adsMove: 0.9, growth: 0.34, decay: 6.8, max: 5.6 },
  ...
  },
  {
    ...
    spread: { hip: 6.0, hipMove: 2.2, ads: 2.6, adsMove: 1.0, growth: 0.0, decay: 5.0, max: 7.0, pelletCone: 3.0 },
